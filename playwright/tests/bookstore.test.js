...
describe(`UI tests for bookstore using playwright`, () => {
    ...
    test(`Should be able to search for the book eloquent javascript`, async() =>{
        await page.fill('#searchBox','eloquent');
    });

    test(`Should check if book image exists`, async() =>{
